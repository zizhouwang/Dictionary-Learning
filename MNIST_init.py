...
for random_state in range (1):
    ...
    with open('W_all_init_'+str(start_train_number)+'.txt', mode='a+', encoding="utf-8") as w:
        w.seek(0)
        w.truncate()
    ...
    with open('A_all_init_'+str(start_train_number)+'.txt', mode='a+', encoding="utf-8") as w:
        w.seek(0)
        w.truncate()
