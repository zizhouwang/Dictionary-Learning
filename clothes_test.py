...
for a2 in range(100):
    for start_change in range(30):
        ...
        D_all=np.load("D_all_"+py_file_name+"_mulD_"+str(w)+"_"+str(h)+'_'+str(transform_n_nonzero_coefs)+'_'+str(start_init_number)+"_"+str(train_number)+"_"+str(update_times)+"_"+str(a2)+".npy")
        W_all=np.load("W_all_"+py_file_name+"_mulD_"+str(w)+"_"+str(h)+'_'+str(transform_n_nonzero_coefs)+'_'+str(start_init_number)+"_"+str(train_number)+"_"+str(update_times)+"_"+str(a2)+".npy")
        ...
        X_test=transform(D_all,Y_test,transform_n_nonzero_coefs,start_change)
